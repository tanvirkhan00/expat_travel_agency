                ...
                <div className="container">
                    <div className='mt-[100px] flex flex-col gap-[30px]'>
                        ...
                        <div className='flex flex-wrap relative justify-between gap-y-[40px]'>
                            <div className='basis-[45%] border-[1px] border-gray-dark px-[70px] py-[20px] rounded-br-[100px] rounded-[10px]'>
                                <img src={Image} alt="" />
                            ...
                            <div className='basis-[45%] border-[1px] border-gray-dark px-[70px] py-[20px] rounded-bl-[100px] rounded-[10px]'>
                                <img src={Image1} alt="" />
                                <div className='mt-[10px]'>
                            ...
                            <div className='basis-[45%] border-[1px] border-gray-dark px-[70px] py-[20px] rounded-tr-[100px] rounded-[10px]'>
                                <img src={Image2} alt="" />
                                <div className='mt-[10px]'>
                            ...
                            <div className='basis-[45%] border-[1px] border-gray-dark px-[70px] py-[20px] rounded-tl-[100px] rounded-[10px]'>
                                <img src={Image3} alt="" />
                                <div className='mt-[10px]'>
