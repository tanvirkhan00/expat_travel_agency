                ...
                <div className="container mt-[100px] py-[50px]">
                    <div>
                        ...
                        <div className='mt-[30px] flex justify-between flex-wrap gap-y-[30px] relative'>
                            ...
                            <span className='absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 transform w-[5px] h-[520px] bg-gray-dark'></span>
                            <span className='absolute border-[1px] border-gray-dark w-[68px] h-[68px] font-bold text-[25px] flex items-center justify-center rounded-full left-1/2 -translate-x-1/2 bg-white'>1</span>
                            <span className='absolute border-[1px] border-gray-dark w-[68px] h-[68px] font-bold text-[25px] flex items-center justify-center rounded-full left-1/2 -translate-x-1/2 bottom-[58%] bg-white'>2</span>
                            <span className='absolute border-[1px] border-gray-dark w-[68px] h-[68px] font-bold text-[25px] flex items-center justify-center rounded-full left-1/2 -translate-x-1/2 bottom-[30%] bg-white'>3</span>
                            <span className='absolute border-[1px] border-gray-dark w-[68px] h-[68px] font-bold text-[25px] flex items-center justify-center rounded-full left-1/2 -translate-x-1/2 bottom-0 bg-white'>4</span>
                        </div>
                    </div>
                </div>
            </section>
